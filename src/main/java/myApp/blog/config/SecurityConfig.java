...
public class SecurityConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:4200","https://blogcocinaapispring-production.up.railway.app"));
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .csrf(csrf -> csrf.disable() ) //desactiva csrf para el API REST
